...
var toastMessage = {
  ...
  setmessage: function (message, statusIcon) {
    // this._creatMessage.innerHTML =
    return `<div class="toastNoti-font-desing">${statusIcon}</div><span>${message}</span>`;
  },
  success: function (message) {
    this._creatMessage.innerHTML = this.setmessage(message, statusIcon.success);
    this.displayMessage();
    this.messagetimeout();
  },
  failed: function (message) {
    this._creatMessage.innerHTML = this.setmessage(message, statusIcon.failed);
    this.displayMessage();
    this.messagetimeout();
  },
  Update: function (message) {
    this._creatMessage.innerHTML = this.setmessage(message, statusIcon.updates);
    this.displayMessage();
    this.messagetimeout();
  },
  Delete: function (message) {
    this._creatMessage.innerHTML = this.setmessage(message, statusIcon.delete);
    this.displayMessage();
    this.messagetimeout();
  },
